...
const Login = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Ekhane aponar login logic/axios call hobe
  };
      ...
      <div className="relative z-10 w-full max-w-[420px]">
        ...
        <div className="bg-white/80 backdrop-blur-md p-8 md:p-10 shadow-2xl border border-white/50 relative overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center px-1">
                ...
                <Link to="/forgot-password" size={14} className="text-[9px] font-bold uppercase tracking-widest text-gray-400 hover:text-black transition-colors">
                  Forgot?
                </Link>
              </div>
              <div className="relative group">
          ...
          <div className="flex items-center my-8">
            ...
            <span className="px-4 text-[10px] font-black text-gray-300 uppercase tracking-widest">Or</span>
            <div className="flex-1 h-[1px] bg-gray-100"></div>
          </div>
        ...
        <p className="text-center mt-8 text-[11px] font-black uppercase tracking-widest text-gray-400">
          Not a member yet?{" "}
          <Link to="/register" className="text-black border-b border-black pb-0.5 hover:text-blue-700 hover:border-blue-700 transition-colors">
            Create Profile
          </Link>
        </p>
      </div>
