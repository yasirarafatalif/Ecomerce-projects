    ...
    <div className="min-h-screen bg-[#F2F2F2] pt-28 pb-20 font-sans">
      <div className="max-w-[1200px] mx-auto px-4 md:px-12">
        ...
        <div className="space-y-6">
          {returns.length > 0 ? (
            returns.map((item) => (
              <div key={item._id} className="bg-white border border-transparent hover:border-black transition-all duration-500 group">
                <div className="p-6 md:p-8 flex flex-col lg:flex-row gap-8 items-start lg:items-center">
                  ...
                  <div className="flex-1 space-y-4 w-full">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                      ...
                      {/* Status Badge */}
                      <div className="flex items-center gap-2 px-4 py-2 bg-gray-50 border border-gray-100">
                    ...
                    {/* Return Note Area */}
                    <div className="p-4 bg-gray-50/50 border-l-2 border-gray-200">
                  ...
                  <div className="flex lg:flex-col gap-2 w-full lg:w-auto">
                    ...
                    <button className="flex-1 lg:w-32 py-3 border border-gray-200 text-[9px] font-black uppercase tracking-widest hover:border-black transition-all">
                       Contact Support
                    </button>
                  </div>
            ...
            /* EMPTY STATE */
            <div className="py-32 text-center bg-white border-2 border-dashed border-gray-200">
